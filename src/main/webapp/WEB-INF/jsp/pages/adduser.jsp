                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    <form:form method="post" modelAttribute="user" cssStyle="width: 50%">
                                        <fieldset class="mb-3">
                                            <form:label path="firstName">Fist Name:</form:label>
                                            <form:input type="text" path="firstName" required="required" cssClass="form-control"/>
                                            <form:errors path="firstName" cssClass="text-warning"></form:errors>
                                        </fieldset>

                                        <fieldset class="mb-3">
                                            <form:label path="lastName">Last Name:</form:label>
                                            <form:input type="text" path="lastName" required="required" cssClass="form-control"/>
                                            <form:errors path="lastName" cssClass="text-warning"></form:errors>
                                        </fieldset>

                                        <fieldset class="mb-3">
                                            <form:label path="email">Email:</form:label>
                                            <form:input type="text" path="email" required="required" cssClass="form-control"/>
                                            <form:errors path="email" cssClass="text-warning"></form:errors>
                                        </fieldset>

                                        <fieldset class="mb-3">
                                            <form:label path="password">Pass word:</form:label>
                                            <form:input type="text" path="password" required="required" cssClass="form-control"/>
